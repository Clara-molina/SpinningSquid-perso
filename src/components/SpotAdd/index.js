  ...
  <div className="spotadd-container">
    ...
    <form className="spotadd-form">
      ...
      <div className="spotadd-container-equipment">
        ...
        <label htmlFor="parking" className="spotadd-label-equipment">Parking
          <input
            id="parking"
        ...
        <label htmlFor="water" className="spotadd-label-equipment">Eau potable
          <input
            id="water"
            className="spotadd-check-equipment"
            type="checkbox"
        ...
        <label htmlFor="trashcan" className="spotadd-label-equipment">Poubelle
          <input
            id="trashcan"
            className="spotadd-check-equipment"
            type="checkbox"
        ...
        <label htmlFor="lighting" className="spotadd-label-equipment">Eclairage
          <input
            id="lighting"
            className="spotadd-check-equipment"
            type="checkbox"
        ...
        <label htmlFor="table" className="spotadd-label-equipment">Table
          <input
            id="table"
            className="spotadd-check-equipment"
            type="checkbox"
        ...
        <label htmlFor="benche" className="spotadd-label-equipment">Banc
          <input
            id="benche"
            className="spotadd-check-equipment"
            type="checkbox"
      ...
      <div className="spotadd-container-image">
        ...
        <label htmlFor="image" className="spotadd-label-image">Parcourir
          <input
            id="image"
      ...
      <div className="spotadd-container-state">
        ...
        <label htmlFor="new" className="spotadd-label-state">Neuf
          <input
            id="new"
        ...
        <label htmlFor="good" className="spotadd-label-state">Bien
          <input
            id="good"
            className="spotadd-radio"
            type="radio"
        ...
        <label htmlFor="way" className="spotadd-label-state">Moyen
          <input
            id="way"
            className="spotadd-radio"
            type="radio"
        ...
        <label htmlFor="endoflife" className="spotadd-label-state">En fin de vie
          <input
            id="endoflife"
            className="spotadd-radio"
            type="radio"
      ...
      <button type="submit" className="spotadd-button">Ajouter un Spot</button>
    </form>
  </div>
);
